...
const FifthContainer = () => {
  return <div>
    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
        ...
        <button className="lg:max-w-[260px] md:max-w-[240px] sm:max-w-[230px] max-w-[220px] bg-white text-black px-5 py-3 rounded-full font-bold lg:text-lg md:text-base sm:text-sm text-xs lg:mt-8 lg:leading-6 md:leading-3 sm:leading-[8px] hover:bg-[#e2d0d0] hover:scale-110 transition-all duration-500">
